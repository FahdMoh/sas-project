...
// ── Navbar Left SVG ─────────────────────────────────────────────────────────
// The left section of the navbar decoration (left half of the 966×73 bar).
...
// ── Navbar Right SVG ─────────────────────────────────────────────────────────
// The right section of the navbar decoration (right half of the 966×73 bar).
const NavbarRightSVG: React.FC = () => (
  ...
  >
    {/* Angled neutral line (right half) */}
    <path
      ...
      fill="#B3B3B3"
    />
    {/* Long horizontal neutral line (right half) */}
    <path
      d="M483 39.1232H958.69V38.3884H483V39.1232Z"
      fill="#B3B3B3"
    />
    {/* White arrow elements */}
    <path
...
// Vertical tech strip — positioned at the far left of the page.
// Scaled so its height covers the full viewport (100vh).
...
// Same paths as LeftSideSVG but flipped horizontally via scaleX(-1).
  ...
  return (
    ...
    >
      ...
      {/* ════════════════════════════════════════════════════════════════════
          ...
          Left half anchored to left edge, right half anchored to right edge.
      ════════════════════════════════════════════════════════════════════ */}
      <div
        id="login-navbar-bar"
        aria-hidden="true"
      ...
      >
        {/* Left half of the navbar SVG decoration */}
        <div style={{ flex: '0 0 50%', height: '100%' }}>
          <NavbarLeftSVG />
        </div>

        {/* Right half of the navbar SVG decoration */}
        <div style={{ flex: '0 0 50%', height: '100%' }}>
          <NavbarRightSVG />
        </div>
      </div>
      ...
      {/* ════════════════════════════════════════════════════════════════════
          ...
          Width: 97px (native SVG width).
          Height: 100vh — SVG scales to fill full viewport height.
      ════════════════════════════════════════════════════════════════════ */}
      <div
        id="login-left-strip"
        aria-hidden="true"
      ...
      {/* ════════════════════════════════════════════════════════════════════
          ...
          Mirror of the left strip via scaleX(-1) inside the SVG.
      ════════════════════════════════════════════════════════════════════ */}
      <div
        id="login-right-strip"
        aria-hidden="true"
        style={{
          position: 'absolute',
          top: 0,
